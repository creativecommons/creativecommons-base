...
class ThemeSettings {
	...
	public function saveSettings() {
		...
		if ( ! wp_verify_nonce( $_POST['_site_settings_nonce'], 'update_site_settings' ) ) {
			wp_die( _x( 'You are not supposed to do that', 'site settings error', 'cc-theme-base' ) );
		}
		if ( ! current_user_can( 'edit_theme_options' ) ) {
			wp_die( _x( 'You are not allowed to edit this options', 'site settings error', 'cc-theme-base' ) );
		}
		$fields                  = array(
			'enable_featured',
			'featured_image',
