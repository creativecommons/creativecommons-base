...
class WP_Widget_Card extends WP_Widget
{
	...
	function form($instance)
	{
		...
		echo '</select>';
		echo '</p>';
		echo '<p><label>Card format: </label>';
		echo '<select class="widefat" id="' . $this->get_field_id('type') . '" name="' . $this->get_field_name('type') . '">';
		echo '<option value="">Select format</option>';
		echo '<option value="card-post" ' . (($instance['type'] == 'card-post') ? 'selected="selected"' : '') . '>Card post</option>';
		echo '<option value="card-image" ' . (($instance['type'] == 'card-image') ? 'selected="selected"' : '') . '>Content</option>';
		echo '</select>';
		echo '</p>';
